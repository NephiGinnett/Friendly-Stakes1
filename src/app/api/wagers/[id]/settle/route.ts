...
import { settleWager } from "../vote/route";
...
export async function POST(
  ...
  try {
    const { winnerSide } = await req.json(); // "for" or "against"
    ...
    // Make sure the winning side actually has participants
    ...
    await settleWager(wagerId, winnerSide, "admin");
